...
import { Box, Button, Checkbox, Divider, FormControl, FormLabel, Input, Modal, ModalBody, ModalCloseButton, ModalContent, ModalFooter, ModalHeader, ModalOverlay, Radio, RadioGroup, Stack, Table, Tbody, Td, Th, Thead, Tr, useDisclosure } from '@chakra-ui/react';
...
export const CalendarComponent: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setNewEvent({ title: '', start: '', end: '', priority: 'low', backgroundColor: '' });
        onClose();
    };
